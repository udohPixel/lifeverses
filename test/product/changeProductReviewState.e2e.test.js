...
const changeProductReviewStateCtrl = require("../../product/controllers/changeProductReviewState.controller");
...
describe("CHANGE PRODUCT STATE E2E TEST", () => {
  describe("POSITIVE TEST", () => {
    ...
    it("should change a product review active state successfully", async () => {
      ...
      await changeProductReviewStateCtrl(req, res);
      ...
      expect(json.args[0][0].message).to.equal("Product review state changed successfully");
      expect(json.args[0][0].data).to.equal(false);
    });
  });
  ...
  describe("NEGATIVE TEST", () => {
    ...
    it("should not change a product review active state successfully when product is not found by id", async () => {
