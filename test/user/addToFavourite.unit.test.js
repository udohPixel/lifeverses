...
const { addToFavourite } = require("../../user/services/addToFavourite.service");
const { stubFindOneScripture, stubByIdUpdateUser } = require("../helpers/helper.sinon");

// add to favourite test
describe("ADD TO FAVOURITE UNIT TEST", () => {
  ...
  it("should add scripture to favourite successfully", async () => {
    ...
    const response = await addToFavourite(userData.id, inputData.scriptureId);
