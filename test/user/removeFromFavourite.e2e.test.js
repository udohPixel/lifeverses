...
describe("REMOVE FROM FAVOURITE E2E TEST", () => {
  describe("POSITIVE TEST", () => {
    ...
    it("should remove scripture to favourite successfully", async () => {
      const req = {
        body: inputData,
        user: userData
      };

      const stubFindUser = stubFindByIdUser(foundData1);
      ...
      expect(json.args[0][0].message).to.equal("Scripture was removed from favourite successfully");
  ...
  describe("NEGATIVE TEST", () => {
    ...
    const userData = { ...favouriteData.userData.valid };
    const foundData2 = { ...favouriteData.foundData.valid1 };
    ...
    it("should not remove scripture to favourite successfully when scripture is not found", async () => {
      const req = {
        body: inputData,
        user: userData
      };
